...
#### 远程英雄 (3种) - 超大范围攻击能力
- **OrangeCat**: 橘猫射手 - 基础射手，高攻速，子弹攻击，**超大攻击范围**
- **PersianSniper**: 波斯猫狙击手 - 高伤害狙击手，暴击能力，**超大攻击范围**
- **BengalHunter**: 孟加拉猎手 - 快速攻击的机敏射手，**超大攻击范围**

**重要特性**：所有远程射击英雄拥有**超大攻击范围**，攻击范围覆盖整个战场区域，可以攻击地图上任意位置的敌人。这使得远程英雄具有独特的战术价值，能够优先清理高价值目标或远距离威胁。

**战术优势**：
- 🎯 **超大覆盖范围**：攻击范围覆盖整个战场，可攻击任意位置的敌人
- 🚀 **灵活部署**：可部署在任意位置，不受范围约束
